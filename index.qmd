...
Les restaurants à moins de 5 minutes à pieds de la gare sont les suivants :
...
Le package osrm propose un calcul d'isochrones, à l'aide de la fonction `osrmIsochrone()`.
...
leg(type = "cont", val = c(min(routes$distance), 1000, max(routes$distance)),
    pal = pal, pos = "topright", title = "Distance (m)")
